...
def test_board_initialization_and_defaults():
    """
...
def test_current_key_setter_validation():
    """
...
def test_highlighted_number_setter_validation():
    """
